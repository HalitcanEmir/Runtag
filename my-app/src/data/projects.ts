...
export const projects: Project[] = [
  ...
  {
    slug: "goruntu-tanimlama",
    category: "Yapay Zeka",
    categorySlug: "yapay-zeka",
    name: "Görüntü Tanıma Sistemi",
    shortDescription: "Derin öğrenme tabanlı nesne ve sahne tanıma platformu",
    longDescription:
      "Derin öğrenme ve bilgisayar görüşü teknolojileri kullanılarak geliştirilen görüntü tanıma sistemi. Yüklenen görsellerdeki nesneleri, sahneleri ve desenleri otomatik olarak tanımlayıp sınıflandırır. Eğitilmiş CNN modelleri ile yüksek doğruluk oranı sunar.",
    ...
    technologies: [
      { name: "PyTorch", purpose: "Derin öğrenme model eğitimi" },
      { name: "OpenCV", purpose: "Görüntü işleme ve ön işleme" },
      { name: "CNN", purpose: "Konvolüsyonel sinir ağı mimarisi" },
      { name: "Transfer Learning", purpose: "Önceden eğitilmiş model adaptasyonu" },
    ],
    team: [
      { name: "Halitcan E.", role: "ML Engineer" },
      { name: "AI Ekibi", role: "Model Eğitimi & Test" },
    ],
